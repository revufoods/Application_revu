...
class DetailsBakeryScreen extends StatelessWidget {
  const DetailsBakeryScreen({Key? key});

  @override
  Widget build(BuildContext context) {
    final bakeryAliado = Provider.of<AuthProvider>(context);
    final Map<String, dynamic> bakeryResponse =
        ModalRoute.of(context)!.settings.arguments as Map<String, dynamic>;
    final aliadoId = bakeryResponse['aliadoId'];
    final branchId = bakeryResponse['branchId'];

    return Scaffold(
        appBar: AppBar(
          title: const Text('Bakery details'),
          backgroundColor: colorPrimary,
        ),
        body: FutureBuilder<BakeryAliado?>(
          future: bakeryAliado.bakeryAliado(aliadoId, branchId),
              ...
              child: Column(
                ...
                children: [
                  ...
                  FutureBuilder<RevuSopresa?>(
                    future: bakeryAliado.revuSopresaBakery(aliadoId, branchId),
                      ...
                      return Column(
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            ...
                            onPressed: bakeryAliado.autenticando
                                ? () => {}
                                : () async {
                                    ...
                                    final buyOk =
                                        await bakeryAliado.payment(products);
